...
public class TestProperties {
  ...
  protected Map<String, String> loadProperties() throws IOException {
    ...
    try (InputStream os = getClass().getClassLoader().getResourceAsStream("test.properties")) {
      Assert.assertNotNull("test.properties must be preset on test classpath, see https://github.com/takari/takari-plugin-testing-project/testproperties.md for me details", os);
      p.load(os);
    }
