...
// some of the code was originally copied from org.apache.maven.plugin.testing.AbstractMojoTestCase and
...
class Maven30xRuntime implements MavenRuntime {
    ...
    private Map<String, MojoDescriptor> readPluginXml(DefaultPlexusContainer container) throws Exception {
        ...
        while (resources.hasMoreElements()) {
            ...
            // Due this commit to prevent NPE
            // https://github.com/apache/maven/commit/05b748ff6aa15aa63a9c9d5f9f5679f47bf9e83d
    ...
    public MavenSession newMavenSession(File basedir) throws Exception {
        ...
        try {
            Object repositorySession = maven.getClass()
                    .getMethod("newRepositorySession", MavenExecutionRequest.class)
                    .invoke(maven, request);
            Class<?> repositorySessionClass = repositorySession
                    .getClass()
                    .getClassLoader()
                    .loadClass("org.sonatype.aether.RepositorySystemSession");
            Constructor<MavenSession> constructor = MavenSession.class.getConstructor(
                    PlexusContainer.class,
                    repositorySessionClass,
